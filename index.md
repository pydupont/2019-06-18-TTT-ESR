...
carpentry: "swc"    # what kind of Carpentry (must be either "lc" or "dc" or "swc"). Be sure to update the Carpentry type in _config.yml as well.  
...
helper: ["David Wood", "Sarah Pirikahu"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
